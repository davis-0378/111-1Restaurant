		...
		button1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (username.getText().length() == 0 || new String(password.getPassword()).length() == 0)
					...
					result = JOptionPane.showConfirmDialog(null, "Welcome 廚師! Work now?", "", JOptionPane.YES_NO_OPTION);
					if (result == 0) {
						dispose();
						new Cook();
					}
					...
					result = JOptionPane.showConfirmDialog(null, "Welcome 服務生! Work now?", "", JOptionPane.YES_NO_OPTION);
					if (result == 0) {
						dispose();
						new Server();
					}
					...
					result = JOptionPane.showConfirmDialog(null, "Welcome 櫃檯! Work now?", "", JOptionPane.YES_NO_OPTION);
					if (result == 0) {
						dispose();
						new Reception();
					}
					...
					result = JOptionPane.showConfirmDialog(null, "Welcome 雜工! Work now?", "", JOptionPane.YES_NO_OPTION);
					if (result == 0) {
						dispose();
						new Manager();
					}
					...
					result = JOptionPane.showConfirmDialog(null, "Welcome 經理! Work now?", "", JOptionPane.YES_NO_OPTION);
					if (result == 0) {
						dispose();
						new Others();
					}
